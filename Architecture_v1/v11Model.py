...
class EnsembleManager:
    ...
    def run_backtest(self, start_date=None, end_date=None, plot_results=True):
            ...
            if risk_override_active and override_flag == "RISK_MAX":
                ...
                if is_bearish_jump:
                    ...
                    if all(a > conviction_thresh for a in agent_actions.values()):
                        ...
                        if not risk_override_active: override_flag = "-"
        ...
        if plot_results:
            ...
            print(f"\n=== V11 FINAL REPORT: {total_ret:.2%} (Bench: {bench_ret:.2%}) ===")
...
if __name__ == "__main__":
    from v11Model import DEFAULT_CONFIG, EnsembleManager
    ...
    print("\n>>> INITIALIZING V11 RISK-MANAGED MODEL <<<")
